...
{if count($conf->roles)>0}
        <a href="{$conf->action_root}profil" class="pure-menu-heading pure-menu-link">Profil</a>
...
{else}	
	...
	<a href="{$conf->action_root}register" class="pure-menu-heading pure-menu-link">Rejestracja</a>
{/if}
</div>
